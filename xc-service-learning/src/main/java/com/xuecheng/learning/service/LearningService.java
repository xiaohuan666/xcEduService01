...
//        }
    ...
    /*public ResponseResult addCourse(String userId, String courseId, String valid, Date startTime, Date endTime, XcTask xcTask){
        ...
        XcLearningCourse course = xcLearningCourseRepository.findByUserIdAndCourseId(userId, courseId);
        if (course!=null){
            //更新选课信息
            ...
            //新建选课信息
            XcLearningCourse course1 = new XcLearningCourse();
            course1.setCourseId(courseId);
            course1.setUserId(userId);
            course1.setValid(valid);
            course1.setStartTime(startTime);
            course1.setEndTime(endTime);
            course1.setStatus("501001");
            xcLearningCourseRepository.save(course1);
